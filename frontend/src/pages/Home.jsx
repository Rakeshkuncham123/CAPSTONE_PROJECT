...
export default function Home() {
  return (
    <div className="font-sans text-gray-800 overflow-x-hidden">
      ...
      {/* IMPACT */}
      <section className="bg-gradient-to-r from-emerald-800 to-emerald-600 text-white py-20 px-6 grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 text-center">
